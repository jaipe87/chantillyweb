...
let metodos = {
    RefreshDatosBocaditos: async (pagina = 1, limite = 8) => {
        let criterio = $("#searchInput").val();

        let url = new URL(urlpath + "/Bocaditos/refresh_datos_bocaditos/");
...
//YA ESTÁN TODOS LOS BOTONES DE AGREGAR AL CARRITO DE TODAS LAS PÁGINAS, SOLO FALTA LA DE AÑADIR AL CARRITO
//TAMBIÉN LA DE OBTENER LAS OPCIONES PARA AGREGARLO A DETALLE.TPL Y SE AGREGUEN EN EL CARRITO
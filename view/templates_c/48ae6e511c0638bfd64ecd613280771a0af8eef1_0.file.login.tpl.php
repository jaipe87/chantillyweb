<?php
/* Smarty version 3.1.34-dev-7, created on 2020-06-13 11:06:32
  from 'C:\xampp\htdocs\admin_amk\view\templates\login.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5ee4f988970609_21004362',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '48ae6e511c0638bfd64ecd613280771a0af8eef1' => 
    array (
      0 => 'C:\\xampp\\htdocs\\admin_amk\\view\\templates\\login.tpl',
      1 => 1592064390,
      2 => 'file',
    ),
  ),
...
function content_5ee4f988970609_21004362 (Smarty_Internal_Template $_smarty_tpl) {
?><!doctype html>
<!--[if lt IE 7]>
    ...
    <div class="container">
        <div class="login-content">
            <div class="login-logo">
                <a href="./">
                    <img class="align-content" src="<?php echo $_smarty_tpl->tpl_vars['asset']->value;?>
            ...
            <div class="login-form">
                <form>
                    <div class="form-group">
                        <label>Nro. RUC</label>
                        <input type="text" class="form-control" placeholder="Ingrese su RUC" id="txtRuc" maxlength="11" autocomplete="off">
                    </div>

                    <div class="form-group">
                        <label for="cboSucursal" class="form-control-label">Sucursal</label>
                        <select id="cboSucursal" data-placeholder="Seleccione un Sucursal"
                                class="standardSelect form-control text-uppercase">

...
class PromocionesController
{
    ...
    public function Index()
    {
        try {
            ...
            $this->tpl->display("promociones.tpl");
        } catch (Exception $e) {
            Session::close();
    ...
    public function refresh_datos_promociones()
    {
        ...
        try {
            ...
            $tblpostres = $daoProductoweb->select_all_Productos_promociones(["cia" => $this->cia, "pagina"=> $id_pagina,"criterio"=>$criterio], $offset, $limite);
            $total_items = $daoProductoweb->select_count_productos_promociones(["cia" => $this->cia, "pagina"=> $id_pagina,"criterio"=>$criterio]);
            $data = [];
            $id = [];
